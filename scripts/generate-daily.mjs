...
const MEDIA_TRENDS = [
  ...
  {
    title: "多巴胺色彩跑 + 30天渐进挑战",
    content: "「多巴胺色彩跑」8月席卷双平台，抖音话题播放15亿+，玩法是每天穿不同颜色去跑步并拍照。小蓝创作建议：立「30天多巴胺色彩跑Flag」，从1公里开始每天递增距离，每天一个颜色主题。视频版用Rap节奏记录公里数递增的成就感。标签：#多巴胺色彩跑 #渐进挑战 #跑步打卡 #30天Flag",
    source: "抖音+小红书双平台热榜"
  },
  {
