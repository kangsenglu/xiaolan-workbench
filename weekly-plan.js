...
window.WEEKLY_PLAN = {
  "weekOf": "2026-08-17",
  "generatedAt": "2026-08-18 08:00 自动生成",
  "menstrualPhase": "未知（未填写经期数据，按卵泡期强度生成）",
  "intensity": 0.6,
  "summary": "本周运动计划以「核心力量 + 有氧 + 颈腰椎护理」三线并行。周一至周五交替进行易筋经组合与田田力量训练，每日搭配腰颈护理操，重点改善久坐造成的颈腰椎不适。周三、周日安排游泳作为有氧恢复，周六增加易筋经训练量并加入面部锻炼。整体强度系数 0.6，中低强度，适合恢复期或经期调整。注意训练后充分拉伸，保证每日饮水 2000ml 以上。",
  "days": [
    {
      "day": "周一",
      "exercises": [
